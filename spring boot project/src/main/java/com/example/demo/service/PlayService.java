...
public class PlayService {
    ...
    public List<PlayResponse> getPlayList() {

        Map<String, List<String>> transformationRules = new HashMap<>();
        transformationRules.put("stringJsonToHashMap", List.of("json"));
        transformationRules.put("stringToInt", List.of("price"));
        return playRepository.findAll().stream()
                .map(play -> mapEntityToDto(play, PlayResponse.class, transformationRules)).toList();
    }
